...
public class DetailPesananActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(DetailPesananActivity.this);
        preference = new UserPreferences(DetailPesananActivity.this);
        ...
        btnPesan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(DetailPesananActivity.this);
        ...
        getData.enqueue(new Callback<Food>() {
            ...
            public void onResponse(Call<Food> call, Response<Food> response) {
                ...
                if(listKeranjang.size() > 0){
                    ...
                    Toast.makeText(DetailPesananActivity.this, "Tidak Ada Data!", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Food> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(DetailPesananActivity.this, "Gagal mengambil data", Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void setAdapter() {
        mRvKeranjang.setLayoutManager(new LinearLayoutManager(DetailPesananActivity.this, LinearLayoutManager.VERTICAL, false));
        mRvKeranjang.setHasFixedSize(true);
        adapterKeranjang = new KeranjangAdapter(DetailPesananActivity.this, listKeranjang, new KeranjangAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                Toast.makeText(DetailPesananActivity.this, "Pesanan Anda!", Toast.LENGTH_SHORT).show();
            }
        });

        adapterKeranjang.setPositif(DetailPesananActivity.this, listKeranjang, new KeranjangAdapter.OnPositifClickListener() {
            @Override
        ...
        adapterKeranjang.setNegatif(DetailPesananActivity.this, listKeranjang, new KeranjangAdapter.OnNegatifClickListener() {
            @Override
        ...
        login.enqueue(new Callback<ResponsModel>() {
            ...
            public void onResponse(Call<ResponsModel> call, Response<ResponsModel> response) {
                ...
                if (kode.equals("1")) {
                    ...
                    Toast.makeText(DetailPesananActivity.this, "Delete Keranjang Berhasil!", Toast.LENGTH_SHORT).show();

                    getFoodCart(preference.getUserId());

                } else {
                    Toast.makeText(DetailPesananActivity.this, "Delete Data failed!!", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ResponsModel> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(DetailPesananActivity.this, "Network Error " + t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        login.enqueue(new Callback<ResponsModel>() {
            ...
            public void onResponse(Call<ResponsModel> call, Response<ResponsModel> response) {
                ...
                if (kode.equals("1")) {
                    ...
                    Toast.makeText(DetailPesananActivity.this, "Pesanan Berhasil!", Toast.LENGTH_SHORT).show();
                    finish();

                } else {
                    Toast.makeText(DetailPesananActivity.this, "Tambah Data failed!!", Toast.LENGTH_SHORT).show();
                }
        ...
        login.enqueue(new Callback<ResponsModel>() {
            ...
            public void onResponse(Call<ResponsModel> call, Response<ResponsModel> response) {
                ...
                if (kode.equals("1")) {
                    ...
                    Toast.makeText(DetailPesananActivity.this, "Update Status Berhasil!", Toast.LENGTH_SHORT).show();
                    finish();

                } else {
                    Toast.makeText(DetailPesananActivity.this, "Update Data failed!!", Toast.LENGTH_SHORT).show();
                }
