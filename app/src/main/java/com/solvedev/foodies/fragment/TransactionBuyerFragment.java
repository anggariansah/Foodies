 ...
 */
public class TransactionBuyerFragment extends Fragment {
    ...
    public TransactionBuyerFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_transaction_buyer, container, false);
    }
    ...
    private void getFoodTransaction(String idpembeli) {
        ...
        Call<Food> getData = api.getTransaksiBuyer(idpembeli);
